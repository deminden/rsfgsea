...
2. Read the [Algorithm Guide](./algorithms.md) if you need to understand mode selection, score semantics, or GPU behavior.
3. Read the [Reproducibility Guide](./reproducibility.md) for parity workflows, scripts, and reference data generation.
4. Read the [Development Guide](./development.md) if you are changing code, tests, or release metadata.
